                                    ...
                                    for label, row in response.iterrows():
                                        if db.session.query(Electric_prod_fr_raw).filter(Electric_prod_fr_raw.date == label).count() >= 1:
                                            ...
                                            if db.session.query(Electric_prod_fr).filter(Electric_prod_fr.date == label).count() >= 1:
                                                db.session.query(Electric_prod_fr).filter(Electric_prod_fr.date == label and Electric_prod_fr.sourcetype_id == 1).update( { Electric_prod_fr.production_mw: row['Nucléaire'] } )
                                                db.session.query(Electric_prod_fr).filter(Electric_prod_fr.date == label and Electric_prod_fr.sourcetype_id == 2).update( { Electric_prod_fr.production_mw: row['Gaz'] } )
                                                db.session.query(Electric_prod_fr).filter(Electric_prod_fr.date == label and Electric_prod_fr.sourcetype_id == 3).update( { Electric_prod_fr.production_mw: row['Charbon'] } )
                                                db.session.query(Electric_prod_fr).filter(Electric_prod_fr.date == label and Electric_prod_fr.sourcetype_id == 4).update( { Electric_prod_fr.production_mw: row['Fioul'] } )
                                                db.session.query(Electric_prod_fr).filter(Electric_prod_fr.date == label and Electric_prod_fr.sourcetype_id == 5).update( { Electric_prod_fr.production_mw: row['Hydraulique'] } )
                                                db.session.query(Electric_prod_fr).filter(Electric_prod_fr.date == label and Electric_prod_fr.sourcetype_id == 6).update( { Electric_prod_fr.production_mw: row['Eolien'] } )
                                                db.session.query(Electric_prod_fr).filter(Electric_prod_fr.date == label and Electric_prod_fr.sourcetype_id == 7).update( { Electric_prod_fr.production_mw: row['Solaire'] } )
                                                db.session.query(Electric_prod_fr).filter(Electric_prod_fr.date == label and Electric_prod_fr.sourcetype_id == 8).update( { Electric_prod_fr.production_mw: row['Bioénergies'] } )
                                            else:
